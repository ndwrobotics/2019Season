...
@Autonomous(name = "Rev Auto 2 Gold", group="default")
//@Disabled
public class RevAuto2BlueGold extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        timeAngleEncoderDrive(0, 78, 0.4);
    }
